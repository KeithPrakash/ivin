...
const Contact = () => {
  ...
  return (
    <div className="w-full  bg-white ">
      <div className=" bg-white h-[20dvh] md:h-[20dvh]   rounded-b-2xl w-full"></div>
      ...
      <div className="flex flex-col   lg:grid  lg:grid-cols-2 w-full pt-20px mt-20 max-w-[1000px] mx-auto">
        <div className=" h-auto  flex justify-center items-center w-full pb-20  ">
          <div
            className="rounded-xl  p-[28px] md:p-[50px]  min-w-[320px]bg-gradient-to-tl from-blue-100 to-blue-100  shadow-2xl"
            data-aos="fade-left"
            data-delay="300"
          >
            <form className="flex flex-col w-full     " action={sendMessage}>
              <div>
                <h3 className="font-semibold text-xl pb-5 text-blue-950 ">
                  Lets get in touch
                </h3>
              </div>
